...
{
    public class ProfileListSearchCommand : BaseCommandQuery<IEnumerable<ProfileVM>> { }

    public class ProfileListSearchHandler : IRequestHandler<ProfileListSearchCommand, IEnumerable<ProfileVM>>
    {
        ...
        public async Task<IEnumerable<ProfileVM>> Handle(ProfileListSearchCommand request, CancellationToken cancellationToken)
        {
