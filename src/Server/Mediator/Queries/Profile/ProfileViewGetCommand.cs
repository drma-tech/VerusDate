...
{
    public class ProfileViewGetCommand : BaseCommandQuery<ProfileVM>
    {
        /// <summary>
    ...
    public class ProfileViewGetHandler : IRequestHandler<ProfileViewGetCommand, ProfileVM>
    {
        private readonly IRepository _repo;

        public ProfileViewGetHandler(IRepository repo)
        {
            _repo = repo;
        }

        public async Task<ProfileVM> Handle(ProfileViewGetCommand request, CancellationToken cancellationToken)
        {
            ...
            var result = await _repo.Get<ProfileVM>(SQL, request);
