...
{
    public class InteractionGetBlinksCommand : MediatorQuery<List<InteractionQuery>>
    {
    ...
    public class InteractionGetBlinksHandler : IRequestHandler<InteractionGetBlinksCommand, List<InteractionQuery>>
    {
