...
{
    public class InteractionGetChatListCommand : IRequest<IEnumerable<Shared.ModelQuery.ProfileChatList>> { }

    public class InteractionGetChatListHandler : IRequestHandler<InteractionGetChatListCommand, IEnumerable<Shared.ModelQuery.ProfileChatList>>
    {
        //private readonly IRepository<Shared.ModelQuery.ProfileChatList> _repo;

        public InteractionGetChatListHandler(IRepositoryFactory factory)
        {
            //_repo = factory.RepositoryOf<Shared.ModelQuery.ProfileChatList>();
        }

        public async Task<IEnumerable<Shared.ModelQuery.ProfileChatList>> Handle(InteractionGetChatListCommand request, CancellationToken cancellationToken)
        {
