...
{
    public class ProfileListMatchCommand : MediatorQuery<List<ProfileSearch>>
    {
        public ProfileListMatchCommand() : base(CosmosType.Profile)
        {
        }
    ...
    public class ProfileListAllHandler : IRequestHandler<ProfileListMatchCommand, List<ProfileSearch>>
    {
        ...
        public async Task<List<ProfileSearch>> Handle(ProfileListMatchCommand request, CancellationToken cancellationToken)
        {
